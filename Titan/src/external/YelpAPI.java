...
// This class provide method:
// String getAccessToken();
// JSONArray search(double lat, double lon, String term);
// void queryAPI(double lat, double lon);
// List<Item> getItemList(JSONArray array);
...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "tAl7fKUgtH0GxzF40soPqA";
	private static final String CLIENT_SECRET = "WxWlhD0N6qFC2YyiVizMoESG4FdLLwCa2c2JA4wUVFGtGrfeW59q4SxhTgidG14e";
   ...
   */
	...
	public List<Item> search(double lat, double lon, String term) {
	    ...
	    // this query is a url query format, ...?term=dinner&latitude=40.222&longitude=...
	    ...
	    try {
	    	...
	    	// Create a URLConnection instance, but does not establish the connection yet
	    	//to execute the request we can use the getResponseCode(), connect(), getInputStream() or
	    	...
	    	//getInputStream() returns an input stream that reads response data 
	    	//which is a JSON object, from this open connection 
	    	BufferedReader in = new BufferedReader(new InputStreamReader(connection.getInputStream()));
	    	String inputLine;
	    	StringBuilder response = new StringBuilder();
